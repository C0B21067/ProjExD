...
def show_maze(canvas, maze_lst):
    ...
    canvas.create_rectangle(100,100,200,200,fill="yellow",width=5)
    canvas.create_text(150,150,text="START!")
    canvas.create_rectangle(1300,100,1400,200,fill="red",width=5)
    canvas.create_text(1350,150,text="GOAL!")
